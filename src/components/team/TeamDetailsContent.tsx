...
import QualificationData from '@/assets/jsonData/QualificationData.json'
import SingleQualification from '../qualification/SingleQualification';
import SkillProgressData from '@/assets/jsonData/SkillProgressData.json'
                    ...
                    <div className="team-content-top">
                        <div className="row">
                            <div className="col-xl-6 left-info">
                                <div className="thumb">
                                    <Image src={`/assets/img/team/${thumb}`} alt="Thumb" width={800} height={950} />
                                </div>
                            </div>

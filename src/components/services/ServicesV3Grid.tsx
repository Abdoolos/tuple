import ServiceV3Data from '@/assets/jsonData/ServiceV3Data.json';
import SingleServiceV3 from './SingleServiceV3';

const ServicesV3Grid = () => {
    return (
        <>
            <div className="services-style-three-area bg-dark bg-cover default-padding bottom-less" style={{ backgroundImage: "url(/assets/img/shape/banner-6.jpg)" }}>

...
import FeatureListData from '@/assets/jsonData/FeatureListData.json';
import PopularServiceData from '@/assets/jsonData/PopularServiceData.json';
                        ...
                        <div className="row">
                            <div className="col-xl-8 col-lg-7 pr-45 pr-md-15 pr-xs-15 services-single-content">
                                <div className="service-single-thumb">
                                    <Image src={`/assets/img/services/${thumb}`} alt="Thumb" width={2048} height={1190} />
                                </div>
                                <h2>{title}</h2>
                                <p>{text}</p>

...
import ShowCaseV2Data from '@/assets/jsonData/ShowCaseV2Data.json';
...
const ShowCaseV2 = () => {
    ...
    return (
        <>
            <div className="case-studies-area default-padding" style={{ backgroundImage: `url(/assets/img/shape/30.png)` }}>

...
import BlogCommentData from '@/assets/jsonData/BlogCommentData.json';
...
const BlogSingleSidebarContent = ({ blogInfo, totalBlogs }: BlogSingleProps) => {
                            ...
                            <div className="blog-content col-xl-8 col-lg-7 col-md-12 pr-35 pr-md-15 pl-md-15 pr-xs-15 pl-xs-15">
                                ...
                                <div className="blog-style-one item">
                                    <div className="blog-item-box">
                                        <div className="thumb">
                                            <Image src={`/assets/img/blog/${thumbFull}`} alt="Thumb" width={1255} height={625} />
                                        </div>
                                        <div className="info">
                                            <div className="meta">
                                                <ul>
                                                    <li>
                                                        <i className="fa-solid fa-user"></i> <Link href="#" scroll={false}>Md Sohag</Link>
                                                    </li>
                                                    <li>

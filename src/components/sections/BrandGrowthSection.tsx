...
const BrandGrowthSection = () => {
  const { t } = useLocale();
  const content = t.brandGrowth;

  return (
    <div className="services-style-four-area default-padding" id="brand-growth" style={{ background: 'linear-gradient(135deg, #f8f7ff 0%, #fff 100%)' }}>
      <div className="container">
        <div className="row">
          <div className="col-lg-10 offset-lg-1">
            <div className="site-heading text-center mb-5">
              <div className="d-inline-block px-4 py-2 mb-3" style={{ background: 'rgba(99, 102, 241, 0.1)', borderRadius: '30px' }}>
                <span style={{ color: '#6366f1', fontWeight: '600', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '1px' }}>
        ...
        <div className="row">
          {content.services.map((service, index) => (
            <div className="col-lg-4 col-md-6 mb-4" key={service.slug}>
              <Link href={`/brand-growth/${service.slug}`} className="text-decoration-none">
                <div
                  className="h-100"
                  style={{
                    background: '#fff',
                    borderRadius: '16px',
                    padding: '35px 30px',
                    boxShadow: '0 5px 30px rgba(99, 102, 241, 0.08)',
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 5px 30px rgba(99, 102, 241, 0.08)';

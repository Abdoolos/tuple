"use client";
import shape24Theme from '@/assets/img/shape/24-theme.png';
import shape24 from '@/assets/img/shape/24.png';
import Image from 'next/image';
import PriceV1CardData from '@/assets/jsonData/PriceV1CardData.json';
...
const PriceV1 = ({ priceClass, lightShape = false }: DataType) => {
    return (
        <>
            <div className={`pricing-area default-padding-bottom ${priceClass ? priceClass : ""}`}>
                        ...
                        <div className="col-xl-5">
                            ...
                            <div className="pricing-tab">
                                ...
                                <div className="shape-arrow">
                                    {lightShape ? <><Image src={shape24Theme} alt="Image not found" /></>
                                        : <><Image src={shape24} alt="Image not found" /></>}
                                </div>
                            </div>
                        </div>
